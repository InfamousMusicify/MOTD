...
execute unless score #music motd.config matches 1 unless entity @s[tag=rmt_new] run stopsound @s
execute unless score #music motd.config matches 1 unless entity @s[tag=rmt_new] run playsound minecraft:music_disc.far music @s
