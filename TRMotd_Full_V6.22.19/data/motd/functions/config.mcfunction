...
tellraw @s {"text":"                                                                                ","color":"dark_gray","strikethrough":true}
tellraw @s ["",{"text":"[ ✎ ]","color":"gray","clickEvent":{"action":"suggest_command","value":"/scoreboard players set #music motd.config "},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to enter toggle for 1st time join music. (0=on - 1=off)","color":"gray"},{"text":"\nAccepts: whole numbers 0+\nDefault: 0","color":"dark_gray"}]}}," MOTD 1st Time Join Music ",{"text":"(Current: ","color":"gray"},{"score":{"name":"#music","objective":"motd.config"},"color":"gray"},{"text":")","color":"gray"}]
tellraw @s {"text":"                                                                                ","color":"dark_gray","strikethrough":true}
